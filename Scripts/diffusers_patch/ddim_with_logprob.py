...
def ddim_step_with_logprob(
    ...
    # print("\n DPO - prev_sample: ", prev_sample.requires_grad)
    # print("\n DPO - prev_sample: ", prev_sample.grad_fn)
...
def ddim_step_rlhf(
    ...
    # print("\n RLHF - prev_sample: ", prev_sample.requires_grad)
    # print("\n RLHF - prev_sample: ", prev_sample.grad_fn)
    ...
    return prev_sample.type(sample.dtype)
